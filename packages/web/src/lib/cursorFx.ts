...
// Ported verbatim from OpenMasjidOS packages/ui/src/lib/cursorFx.ts @ c4d309f (v0.40.0) — keep structurally identical for re-sync (CLAUDE.md §15). See packages/web/PORTED_FROM_OPENMASJIDOS.md
/**
